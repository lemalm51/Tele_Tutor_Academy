        ...
        <div className='flex items-center justify-between flex-wrap'>
          ...
          <div className='flex md:flex-row flex-col items-center gap-3 mt-5'>
            ...
            <label htmlFor="thumbnailImage" className='flex items-center gap-3 cursor-pointer'>
              <img src={assets.file_upload_icon} alt="file_upload_icon" className='p-3 bg-blue-500 rounded hover:bg-blue-600 transition-colors'/>
              <input type="file" id='thumbnailImage' onChange={e => setImage(e.target.files[0])} accept="image/*" hidden />
              
              {/* Only show preview when image exists */}
              {image && (
