		...
		<footer className="bg-gray-900 md:px-36 text-left w-full mt-10">
			<div className="flex flex-col md:flex-row items-start px-8 md:px-0 justify-center gap-10 md:gap-32 py-10 border-b border-white/30">
				<div className="flex flex-col md:items-start items-center w-full">
					<img src={assets.scemalogo} alt="logo" />
					<p className="mt-6 text-center sm:flex sm:flex-row sm:justify-center  md:text-left text-sm text-white/80">
						STEM education is made accessible and engaging by connecting students with powerful resources through quality courses, interactive tools, and intuitive design, fostering a seamless environment for discovery and problem-solving.
					</p>
				</div>
				<div className="flex flex-col md:items-start items-center w-full">
				...
				<div className="md:flex flex-col items-start w-full">
					<h2 className="font-semibold text-white mb-5">
						Search for subject material
					</h2>
					<p className="text-sm text-white/80">
						Latest academic resources are available enjoy them.
					</p>
			...
			<p className="py-4 text-center text-xs md:text-sm text-white/60">
				Copyright 2025 © STEMA by GP4. All Right Reserved.
			</p>
		</footer>
	);
};
