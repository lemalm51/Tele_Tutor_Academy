...
const CallToAction = () => {
  ...
  return (
    <div className='flex flex-col items-center gap-4 pt-10 pb-24 px-8 md:px-0'>
      <h1 className='text-xl md:text-4xl text-gray-800 font-semibold'>Learn STEM, anytime, anywhere</h1>
      <p className='text-gray-500 sm:text-sm'>Whether you're a student looking to enhance your knowledge or an educator wanting to share expierence, STEMA  is the perfect platform for you.
